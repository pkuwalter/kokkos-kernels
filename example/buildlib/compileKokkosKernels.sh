KOKKOS_PATH=/vpublic01/frog/zhengzhigao/kokkospro/kokkos #path to kokkos source
...
KOKKOSKERNELS_PATH=/vpublic01/frog/zhengzhigao/kokkospro/kokkos-kernels #path to kokkos-kernels top directory.
...
KOKKOS_DEVICES=Cuda #Serial,Cuda,OpenMP #devices Cuda...
